    ...
    <div id="testimonials" className={styles.testimonials}>
      <div className={styles.content}>
        <div className={styles.textual}>
          <Headings h2={'Testimonials'} h3={'Kind words from partners'} />
          <div className={styles.testimonials}>
            <Testimonial
              avatar={edgar}
              author={'Edgar Azevedo'}
              website={
                'https://www.linkedin.com/in/edgar-azevedo-dos-santos-filho-140a2b128'
              }
              testimonial={`The georeferencing tool created by Yago was a real game-changer for our team. 
            ...
            <Testimonial
              ...
              website={
                'https://www.linkedin.com/in/leonardo-medeiros-dr-6088443'
              }
              testimonial={`Yago is a focused professional with diverse skills and can contribute to your projects either as a Musician or a Software Engineer. 
            ...
            <Testimonial
              ...
              testimonial={`Responsible professional who delivers on his promises — he built my company’s website exactly the way I had envisioned it!`}
